      ...
      <main className="contact-shell loaded relative">
        ...
        <section className="booking-options-section fade-section" style={{ padding: "0 2rem 4rem 2rem" }}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                {/* Group / Intersecting Elements Icon */}
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                {/* Matching Tattoos / Twin Parallel Infinity Lines Icon */}
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <section className="contact-grid fade-section">
          <div className="contact-card contact-form-card">
            ...
            <form className="contact-form" onSubmit={(e) => e.preventDefault()}>
              ...
              <label>
                {t('message')}
                <textarea rows={5} placeholder="Tell us about your event, brand activation, group size, or custom tattoo concept..." />
              </label>
